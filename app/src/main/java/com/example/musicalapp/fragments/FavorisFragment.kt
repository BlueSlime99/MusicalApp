...
class FavorisFragment(
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?
        ...
        val view =  inflater?.inflate(R.layout.fragment_favoris, container, false)//injecter le fragment dans la page
        val favorisList = arrayListOf<TitresModel>()
        ...
        horizontalRecyclerView.adapter = TitreAdapter(context,favorisList,R.layout.item_vertical_details_titre) //charger les titres
        ...
        verticaldetailsRecyclerView.adapter = TitreAdapter(context,favorisList,R.layout.item_vertical_details_titre) //charger les titres
