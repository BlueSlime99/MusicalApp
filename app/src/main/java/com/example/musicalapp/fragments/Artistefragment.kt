...
class ArtisteFragment(
    private val context : MainActivity
) : Fragment(){ //la creation du fragment appelle le oncreatView

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?
    ): View? {
        val view =  inflater?.inflate(R.layout.fragment_artiste, container, false)//injecter le fragment dans la page
        ...
        val horizontalRecyclerView = view.findViewById<RecyclerView>(R.id.album_recycler_view)
        ...
        val verticaldetailsRecyclerView = view.findViewById<RecyclerView>(R.id.titre_recycler_view)
        ...
        val item_artiste = view.findViewById<RecyclerView>(R.id.card_view)
        item_artiste.adapter = TitreAdapter(context, albumsList, R.layout.item_artiste) //charger les titres
        item_artiste.addItemDecoration(TitreItemDecoration())
